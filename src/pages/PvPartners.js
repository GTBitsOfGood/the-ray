...
import '../static/css/PvPartners.css';
...
class PvPartners extends React.PureComponent {
  render() {
    return (
      <div className="partners-background">
        <div className="partners-body">
          ...
          <img className="hannah" src={hannahlogo} alt="Hannah logo" />
